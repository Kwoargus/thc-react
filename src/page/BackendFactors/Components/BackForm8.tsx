                ...
                <Form.Item label="8. Выберите вариант степени заполнения таблиц тестовыми данными:">
                    <Radio.Group onChange={onChange} value={value}>
                        <Space direction="vertical">
                            <Radio value={0}>
                                {" "}
                                1. Необходимые тестовые данные в таблицы внесены, они полны и корректны. [0 storypoints]
                            </Radio>
                            <Radio value={2}>
                                {" "}
                                2. Часть необходимых тестовых данных в таблицы не внесены или некорректны и/или не определена часть связей. [2 storypoints]
                            </Radio>
                            <Radio value={5}>
                                {" "}
